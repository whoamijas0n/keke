...
BORDER_COLOR = "#000000"  # borde negro para botones
...
class RedTeamApp(tk.Tk):
    def __init__(self):
        ...
        # Estilos ttk oscuros con bordes negros
        style = ttk.Style()
        ...
        style.configure('Gray.TLabel', background=COLOR_FONDO_PRINCIPAL,
                        foreground='#aaaaaa', font=('Helvetica', 10))
        # Botones rojos con borde negro
        style.configure('Red.TButton',
                        background=COLOR_BOTON_ROJO,
                        foreground='white',
                        borderwidth=2,
                        relief='raised',
        ...
        style.configure('Danger.TButton',
                        background=COLOR_BOTON_PELIGRO,
                        foreground='black',
                        bordercolor=BORDER_COLOR,
                        highlightthickness=0)
        ...
        # Frame de contenido accesible como propiedad
        self.back_btn = None
    ...
    def agregar_boton_atras(self, callback):
        self.back_btn = ttk.Button(self.content, text="← Atrás", style='Gray.TButton',
                                   width=8, command=callback)
        self.back_btn.pack(anchor="nw", padx=2, pady=2)

    def mostrar_consola(self):
        self.console_textbox = tk.Text(self.content, height=4, bg='#0a0a0a',
    ...
    def show_inicio_menu(self):
        ...
        ttk.Label(self.content, text="DRAGON FLY SYSTEM", style='Title.TLabel').pack(pady=(8,2))
        ttk.Label(self.content, text="Red Team Toolbox", style='Gray.TLabel').pack(pady=(0,6))
    ...
    # ==========================================
    # MENÚ RECONOCIMIENTO (NMAP) – 13 escaneos
    # ==========================================
    def show_recon_menu(self):
        self.session_dir_nmap = ""
        self.limpiar_main_frame()
        self.agregar_boton_atras(self.show_inicio_menu)
        ttk.Label(self.content, text="RECONOCIMIENTO (NMAP)", style='Title.TLabel').pack(pady=(2,1))
        ...
        btn_frame = ttk.Frame(self.content, style='Dark.TFrame')
    ...
    def _mostrar_explorador_nmap(self, page=0):
        ...
        frame = ttk.Frame(self.content, style='Dark.TFrame')
        ...
        nav_frame = ttk.Frame(self.content, style='Dark.TFrame')
    ...
    def _mostrar_archivos_nmap(self, ruta, page=0):
        ...
        ttk.Label(self.content, text=nombre, style='Title.TLabel').pack(pady=2)
    ...
    def show_mac_menu(self):
        ...
        sel_frame = ttk.Frame(self.content, style='Dark.TFrame')
        ...
        # Funciones dinámicas que toman el valor actual de la interfaz
        def ver_estado():
            iface = self.interfaz_seleccionada.get()
            self.ejecutar_comando(f"sudo macchanger -s {iface}")
        def mac_random():
            iface = self.interfaz_seleccionada.get()
        ...
        ttk.Button(self.content, text="Ver Estado", style='Red.TButton',
                   command=ver_estado).pack(fill='x', padx=10, pady=2)
        ttk.Button(self.content, text="MAC Random", style='Red.TButton',
                   command=mac_random).pack(fill='x', padx=10, pady=2)
        ttk.Button(self.content, text="Reset Original", style='Red.TButton',
                   command=reset_original).pack(fill='x', padx=10, pady=2)
        ttk.Button(self.content, text="Mismo Fabricante", style='Red.TButton',
                   command=mismo_fabricante).pack(fill='x', padx=10, pady=2)
        self.mostrar_consola()

    # ==========================================
    # MENÚ AUDITORÍA WIFI (completo)
    # ==========================================
    ...
    def _wifi_seleccionar_cliente_handshake(self, red):
        ...
        if total_pages > 1:
            ...
            def paginar(p):
                ...
                self.agregar_boton_atras(lambda: self._wifi_mostrar_redes_handshake([red]))
                ttk.Label(self.content, text="CLIENTES", style='Title.TLabel').pack(pady=2)
                frm = ttk.Frame(self.content, style='Dark.TFrame')
                ...
                nf = ttk.Frame(self.content, style='Dark.TFrame')
                nf.pack(pady=2)
                if p > 0:
...
'''
    ...
    # ==========================================
    # MENÚ BLUETOOTH BLE (lazy import)
    # ==========================================
    ...
    def show_bluetooth_menu(self):
        ...
        status_label = ttk.Label(self.content, text=f"Gadget: {gadget_status}",
        ...
        ttk.Button(self.content, text="Explorar Resultados", style='Gray.TButton',
    ...
    def _ble_scan_gadget(self, module):
        ...
        ttk.Label(self.content, text=f"ESCANEANDO (MOD {module})...", style='Title.TLabel').pack(pady=5)
        self.mostrar_consola()
    ...
    def _ble_gadget_mostrar_dispositivos(self, dispositivos, module, page=0):
        self.limpiar_main_frame()
        self.agregar_boton_atras(self.show_bluetooth_menu)
        ttk.Label(self.content, text="DISPOSITIVOS (Gadget)", style='Title.TLabel').pack(pady=2)
        if not dispositivos:
            ttk.Label(self.content, text="No se encontraron.", style='Dark.TLabel').pack()
            return
        items_per_page = 4
    ...
    def _bluejacking_gui(self):
        ...
        if msg:
            ...
            self.limpiar_main_frame()
            self.agregar_boton_atras(self.show_bluetooth_menu)
            ttk.Label(self.content, text="Publicidad activa.", style='Title.TLabel').pack(pady=5)
            ttk.Button(self.content, text="Detener", style='Danger.TButton',
    ...
    def _beacon_flood_gui(self):
        ...
        self.limpiar_main_frame()
        self.agregar_boton_atras(self.show_bluetooth_menu)
        ttk.Label(self.content, text="Flood en curso...", style='Title.TLabel').pack(pady=5)
        ttk.Button(self.content, text="Detener", style='Danger.TButton',
                   command=lambda: self.gadget.stop(0)).pack(pady=5)
        self.mostrar_consola()
    ...
    def _jammer_gui(self):
        ...
        self.limpiar_main_frame()
        self.agregar_boton_atras(self.show_bluetooth_menu)
        ttk.Label(self.content, text=f"Jamming canal {ch_str}", style='Title.TLabel').pack(pady=5)
        ttk.Button(self.content, text="Detener", style='Danger.TButton',
                   command=lambda: self.gadget.stop(0)).pack(pady=5)
        self.mostrar_consola()
    ...
    def _sweep_jammer_gui(self):
        ...
        self.limpiar_main_frame()
        self.agregar_boton_atras(self.show_bluetooth_menu)
        ttk.Label(self.content, text="Barrido activo", style='Title.TLabel').pack(pady=5)
        ttk.Button(self.content, text="Detener", style='Danger.TButton',
                   command=lambda: self.gadget.stop(0)).pack(pady=5)
        self.mostrar_consola()
    ...
    def _ble_escanear(self):
        self.limpiar_main_frame()
        self.agregar_boton_atras(self.show_bluetooth_menu)
        ttk.Label(self.content, text="ESCANEANDO BLE...", style='Title.TLabel').pack(pady=5)
        self.mostrar_consola()
        def escanear():
    ...
    def _mostrar_dispositivos_ble(self, dispositivos, page=0):
        self.limpiar_main_frame()
        self.agregar_boton_atras(self.show_bluetooth_menu)
        ttk.Label(self.content, text="DISPOSITIVOS BLE", style='Title.TLabel').pack(pady=2)
        if not dispositivos:
            ttk.Label(self.content, text="No se encontraron.", style='Dark.TLabel').pack()
            return
        items_per_page = 4
    ...
    # ==========================================
    # MENÚ UTILIDADES (completo)
    # ==========================================
    def show_utils_menu(self):
        self.limpiar_main_frame()
        self.agregar_boton_atras(self.show_inicio_menu)
        ttk.Label(self.content, text="UTILIDADES", style='Title.TLabel').pack(pady=2)
        ...
        for texto, cmd in opciones:
            ttk.Button(self.content, text=texto, style='Red.TButton', command=cmd,
                       width=28).pack(fill='x', padx=10, pady=2)

        ttk.Label(self.content, text="SISTEMA", style='Title.TLabel').pack(pady=(4,2))
        btn_frame = ttk.Frame(self.content, style='Dark.TFrame')
        btn_frame.pack(fill='x', padx=5, pady=2)
        comandos_sys = [
            ("Almacenamiento", "df -h"),
        ...
        sys_opts = ttk.Frame(self.content, style='Dark.TFrame')
    ...
    def _utils_wifi_seleccionar_interfaz(self):
        ...
        ttk.Label(self.content, text="IFACE WIFI", style='Title.TLabel').pack(pady=2)
    ...
    def _utils_wifi_escanear_redes(self, iface):
        ...
        ttk.Label(self.content, text="ESCANEANDO...", style='Title.TLabel').pack(pady=2)
        self.mostrar_consola()
        def escanear():
    ...
    def _utils_wifi_mostrar_redes(self, iface, redes, page=0):
        self.limpiar_main_frame()
        self.agregar_boton_atras(self._utils_wifi_seleccionar_interfaz)
        ttk.Label(self.content, text="REDES", style='Title.TLabel').pack(pady=2)
        if not redes:
            ttk.Label(self.content, text="No disponibles.", style='Dark.TLabel').pack()
            return
        items_per_page = 4
        total_pages = (len(redes) + items_per_page - 1) // items_per_page
        page = max(0, min(page, total_pages-1))
    ...
    def _utils_wifi_conectar(self, iface, ssid, security):
        ...
        ttk.Label(self.content, text=f"CONECTANDO...", style='Title.TLabel').pack(pady=5)
        self.mostrar_consola()
    ...
    def _utils_wifi_mostrar_resultado(self, mensaje, iface):
        self.limpiar_main_frame()
        self.agregar_boton_atras(self._utils_wifi_seleccionar_interfaz)
        ttk.Label(self.content, text="RESULTADO", style='Title.TLabel').pack(pady=5)
        ttk.Label(self.content, text=mensaje, wraplength=300).pack(pady=5)
        self.mostrar_consola()

    def _utils_wifi_estado(self):
        self.limpiar_main_frame()
        self.agregar_boton_atras(self.show_utils_menu)
        ttk.Label(self.content, text="ESTADO WIFI", style='Title.TLabel').pack(pady=5)
        self.mostrar_consola()
        for iface in self.obtener_interfaces_wifi():
    ...
    def _utils_bluetooth_seleccionar_interfaz(self):
        self.limpiar_main_frame()
        self.agregar_boton_atras(self.show_utils_menu)
        ttk.Label(self.content, text="ADAPTADOR BT", style='Title.TLabel').pack(pady=5)
    ...
    def _utils_bluetooth_escanear(self, iface):
        ...
        ttk.Label(self.content, text="ESCANEANDO BT...", style='Title.TLabel').pack(pady=5)
        self.mostrar_consola()
    ...
    def _utils_bluetooth_mostrar_dispositivos(self, iface, dispositivos, page=0):
        self.limpiar_main_frame()
        self.agregar_boton_atras(self._utils_bluetooth_seleccionar_interfaz)
        ttk.Label(self.content, text="DISPOSITIVOS", style='Title.TLabel').pack(pady=2)
        if not dispositivos:
            ttk.Label(self.content, text="No encontrados.", style='Dark.TLabel').pack()
            return
        items_per_page = 4
        total_pages = (len(dispositivos) + items_per_page - 1) // items_per_page
        page = max(0, min(page, total_pages-1))
    ...
    def _utils_bluetooth_conectar(self, iface, mac, nombre):
        ...
        ttk.Label(self.content, text="CONECTANDO...", style='Title.TLabel').pack(pady=5)
        self.mostrar_consola()
    ...
    def _utils_bluetooth_estado(self):
        self.limpiar_main_frame()
        self.agregar_boton_atras(self.show_utils_menu)
        ttk.Label(self.content, text="ESTADO BT", style='Title.TLabel').pack(pady=5)
        self.mostrar_consola()
        for iface in self.obtener_interfaces_bluetooth():
